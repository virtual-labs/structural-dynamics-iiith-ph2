...
* Objective
  - To view the Login of the Structural Dynamics Lab
...
* Test Steps
  ...
  2. Check if there are any distortions and junk characters in the Login page

* Expected result
  1. Login page should be opened
